import { r as registerInstance, h, g as getElement } from './index-e0983af0.js';
...
const PtgBreadcrumbs = class {
  ...
  render() {
    var _a;
    return (h("ul", { class: "breadcrumb" }, (_a = this.datalist) === null || _a === void 0 ? void 0 : _a.map((item, i) => {
      if (this.datalist.length - 1 > i) {
        return h("li", null, h("a", { href: `${item.link}` }, item.title));
      }
...
const PtgButton = class {
  constructor(hostRef) {
    ...
    this.btnIconAlignment = 'right';
  }
  componentWillLoad() {
    this.hasbtnIconSlot = !!this.hostElement.querySelector('[slot="btnIcon"]');
  }
  render() {
    return (h("button", { class: `btn ${this.appearance}`, type: 'button' }, this.btnIconAlignment === 'left' && this.hasbtnIconSlot && (h("div", { class: 'showRight' }, h("slot", { name: "btnIcon" }))), h("span", null, " ", this.text), this.btnIconAlignment === 'right' && this.hasbtnIconSlot && (h("div", { class: 'showLeft' }, h("slot", { name: "btnIcon" })))));
  }
  get hostElement() { return getElement(this); }
};
PtgButton.style = ptgButtonCss;

export { PtgBreadcrumbs as ptg_breadcrumbs, PtgButton as ptg_button };
