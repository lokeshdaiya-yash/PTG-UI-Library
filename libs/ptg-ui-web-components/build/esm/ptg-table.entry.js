...
const PtgTable = class {
  ...
  render() {
    ...
    return (h("div", { class: "ptg-table-wrapper" }, this.searchable && (h("div", { class: "table-search" }, h("ptg-input", { placeholder: "Records.." }))), h("table", { class: {
      ...
      } }, h("thead", null, h("tr", null, (_a = this.tablecolumn) === null || _a === void 0 ? void 0 : _a.map((column) => {
      return (h("th", { class: {
    ...
    }))), h("tbody", null, ((_b = this.tablelist) === null || _b === void 0 ? void 0 : _b.length) < 1 && (h("tr", null, h("td", { colSpan: this.tablecolumn.length, class: "no-record-found" }, h("strong", null, "No data Found")))), (_c = this.tablelist) === null || _c === void 0 ? void 0 :
      _c.map((tableItem) => {
        return (h("tr", null, this === null || this === void 0 ? void 0 : this.tablecolumn.map((column) => {
          return h("td", null, tableItem[column === null || column === void 0 ? void 0 : column.key]);
        })));
      }))), h("ptg-pagination", { page: this.page, pageSize: this.pageSize, pageSizeOptions: [10, 15, 20], itemCount: this.itemCount })));
  }
