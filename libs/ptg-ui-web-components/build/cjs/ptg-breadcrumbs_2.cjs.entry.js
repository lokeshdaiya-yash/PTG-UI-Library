...
const PtgButton = class {
  ...
  render() {
    return (index.h("button", { class: `btn ${this.appearance}`, type: 'button' }, this.btnIconAlignment === 'left' && this.hasbtnIconSlot && (index.h("div", { class: 'showRight' }, index.h("slot", { name: "btnIcon" }))), index.h("span", null, " ", this.text), this.btnIconAlignment === 'right' && this.hasbtnIconSlot && (index.h("div", { class: 'showLeft' }, index.h("slot", { name: "btnIcon" })))));
  }
