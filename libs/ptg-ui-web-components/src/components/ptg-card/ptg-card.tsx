  ...
  render() {
    return (
      <div class="ptg-card-wrapper">
        {this.src !== '' && (
          <div class="ptg-card-img-wrapper">
            <img src={this.src} />
          </div>
        )}
        {(this.cardTitle != '' || this.cardContent !== '') && (
          <div class="ptg-card-content-wrapper">
            {this.cardTitle && (
              <h2 class="ptg-card-heading">{this.cardTitle}</h2>
            )}
            {this.cardContent && (
              <div class="ptg-card-content">
                {this.cardContent.length > this.cardContentLength
        ...
        {this.isCardAction && (
          <div class="ptg-card-footer">
            <ptg-button
              appearance="primary"
              text={this.cardButtonText}
              onClick={() => this.clickbutn(this.cardId)}
            ></ptg-button>
          </div>
        )}
      </div>
