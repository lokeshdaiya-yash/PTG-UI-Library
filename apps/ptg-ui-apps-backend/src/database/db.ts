...
const ptusername = encodeURIComponent(environment.PT_DB_USERNAME);
const ptpassword = encodeURIComponent(environment.PT_DB_PASSWORD);
const dbName = 'test';
...
const ptURL =`mongodb+srv://${ptusername}:${ptpassword}@naruto.sf8tp46.mongodb.net/${ptdbName}?retryWrites=true&w=majority`;
