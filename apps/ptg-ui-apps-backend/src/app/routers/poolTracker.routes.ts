...
router.get("/pool-tracker/band/all", getBand);
...
router.get("/pool-tracker/competency/all", getCompetency);
...
router.get("/pool-tracker/designation/all", getDesignation);
...
router.get("/pool-tracker/masterdata/all", getMasterdata);
...
router.get("/pool-tracker/skill/all", getSkills);
